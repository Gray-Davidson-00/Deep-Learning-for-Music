...
def create_network(network_input, n_vocab):
    ...
    model.load_weights('weights-improvement-198-0.7267-bigger.hdf5')
...
def create_midi(prediction_output):
    ...
    for note_index in range(1, len(midi_stream.notes)):
        if midi_stream.pitches[note_index] == midi_stream.pitches[note_index - 1]:
            counter += 1
        else:
            ...
            midi_stream.notes[note_index - (counter + 1)].duration.quarterLength = float(1 + counter)
            counter = 0
